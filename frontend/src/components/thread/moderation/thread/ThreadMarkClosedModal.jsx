...
export default class extends Form {
  constructor(props) {
    ...
    this.state = {
      ...
      title: "[---CLOSED---] " + props.thread.title,
        ...
        <form onSubmit={this.handleSubmit}>
          <div className="modal-content">
            ...
            <div className="modal-body">
              <FormGroup
                for="id_modal_title"
                label={pgettext("thread title form field", "This function will update thread title to")}
              >
                <input
                ...
                />
                <label>
                  Note that this thread is still visible by others.
                </label>
              </FormGroup>
            </div>
  ...
  return (
    <div className="modal-header">
      ...
      <h4 className="modal-title">
        {pgettext("thread title form title", "Close thread")}
      </h4>
    </div>
  )
}
